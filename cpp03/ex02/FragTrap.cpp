...
/*   Updated: 2023/03/07 13:15:07 by averdon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	FragTrap::highFivesGuys(void)
{
	if (this->_HitPoints > 0 && this->_EnergyPoints > 0)
	{
		...
		std::cout << "FragTrap " << this->_name << " has no HitPoints to do a High Fives\n";
	else if (this->_EnergyPoints <= 0)
		std::cout << "FragTrap " << this->_name << " has no EnergyPoints to do a High Fives\n";
}
